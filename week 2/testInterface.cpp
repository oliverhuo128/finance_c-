...
int main(void)
{
	...
	// Output call and put values, comparing the anlytic result to the MC result. Note that the way we call the PriceOptionMC is the same as in the first version of this code, where that function was separately implented for EuopeanPut and EuropeanCall. Do you understand why?
